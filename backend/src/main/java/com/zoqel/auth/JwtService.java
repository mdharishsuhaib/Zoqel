...
public class JwtService {
    ...
    private String buildToken(Map<String, Object> extraClaims, AppUser userDetails, long expiration) {
        return Jwts.builder()
                .claims(extraClaims)
    ...
    private SecretKey getSignInKey() {
        ...
        if (keyBytes.length < 32) {
            // Pad the key if it's too short for HS256 to avoid exceptions during local testing
