export type FailureReason = 'BANK_TIMEOUT' | 'NETWORK_ERROR' | 'INSUFFICIENT_FUNDS' | 'EXPIRED_CARD' | 'DUPLICATE_ATTEMPT' | 'REPEATED_FAILURE' | 'UNKNOWN' | 'CHECKOUT_ABANDONED' | 'OVERDUE_RECEIVABLE' | 'SUBSCRIPTION_FAILED';
