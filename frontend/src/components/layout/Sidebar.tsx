...
export function Sidebar() {
  ...
  const closeOnMobile = () => setSidebarMobileOpen(false);
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'bg-[#111827] text-[#D1D5DB] flex flex-col shrink-0 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] h-full z-40',
      ...
      >
        ...
        <div className="shrink-0 border-t border-[#1D2939] p-2 overflow-x-hidden">
          ...
          <button
            ...
            className="hidden md:flex w-full items-center justify-center py-2 rounded-lg text-[#6B7280] hover:bg-[#1D2939] hover:text-white transition-colors"
          >
